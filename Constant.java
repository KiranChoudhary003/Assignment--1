...
public class Constant {
	...
	final String STARTED_MATCH = "1. Start Match";
	...
	final String TEAM_NAME = "Enter team name for team ";
	...
	final String INVALID_USER_INPUT = "Invalid Input!! Please write valid Input.";
	final String TEAM = "Team: ";
	final String PLAYER = "Player ";
	final String COLON = ": ";
	final String HYPHEN = " - ";
	final String MATCH_BETWEEN = "Match between ";
	final String AND = " and ";
	final String SETUP = " has been set up!";
	final String TARGET = "Target for Team-2: ";
	final String WINNER = "\u001B[1m\u001B[31m\t\tWinner: \u001B[0m";
	final String SELECTED_PLAYER_NUMBER = "Select player number (1 to ";
	final String BRACKET = "Select player number (1 to ";
	final String SELECTED = " selected.";
	final String STRIKER = "Team Striker: ";
	final String NON_STRIKER = "Team Non Striker";
	final String OVER = "\nOver: ";
	final String BALL =  " | Ball: ";
	final String AMAZED = "Oh no! Player ";
	final String OUT = " is OUT!";
	final String NEW_STRIKER = "Team New Striker: ";
	final String NEW_NON_STRIKER = "Team Non-Striker: ";
